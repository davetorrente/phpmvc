...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" value="<?= isset($_POST['password']) ? $_POST['password'] : ''; ?>" name="password" novalidate>
    ...
    <br>
    <a href="/src/View/register/" class="text-center">Register a new membership</a>
