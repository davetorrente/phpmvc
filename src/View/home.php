<?php
  ...
  if (!$user->session->isUserLoggedIn(true)) {
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="./../../../public/images/user/<?= $_SESSION['user'][0]['pic_name']; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?= $_SESSION['user'][0]['username']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="./../../../public/images/user/<?= $_SESSION['user'][0]['pic_name']; ?>" class="img-circle" alt="User Image">  
                <p>
